...
import { useCanvasRenderer, LogoConfig, BackgroundConfig, VisualizerConfig, ParticleConfig, drawFrame, initParticles, updateParticles, Particle, getAudioAverages } from './hooks/useCanvasRenderer';
